...
### 节点日志采集代理
![17b5914bdca0](https://im.xinn.cc/17b5914bdca0.png)
...
![f794869badf5](https://im.xinn.cc/f794869badf5.png)
...
由于 Pod 中容器的特性，我们可以利用另外一个 sidecar 容器去获取到另外容器中的日志文件，然后将日志重定向到自己的 stdout 流中，可以将上面的 YAML 文件做如下修改：<br />`two-files-counter-pod-streaming-sidecar.yaml`
```yaml
apiVersion: v1
kind: Pod
metadata:
...
![98e86b5080e4](https://im.xinn.cc/98e86b5080e4.png)
...
### 直接从应用程序收集日志
![3a12e50b12a8](https://im.xinn.cc/3a12e50b12a8.png)
